@include = ->
	...
	#
	@view backend_toolboxArticle: ->
		html ->
			div '#tArticleFormSubmit.toolbox.divider nobr', ->
				input '#articleFormSubmit.submit', type: 'button', value: '#ionize_button_save_article'
			div '#tArticleDeleteButton.toolbox.divider nobr', ->
				input '#articleDeleteButton.button.no', type: 'button', value: '#ionize_button_delete'
			div '.toolbox.divider', ->
				input '#sidecolumnSwitcher.toolbar-button', type: 'button', value: '#ionize_show_options'
			div '#tArticleDuplicateButton.toolbox.divider', ->
				span '#articleDuplicateButton.iconWrapper', ->
					img src: '/images/icon_16_copy_article.gif', width: '16', height: '16', alt: '#ionize_button_duplicate_article', title: '#ionize_button_duplicate_article'
			div '#tArticleAddContentElement.toolbox.divider', ->
				input '#addContentElement.toolbar-button.element', type: 'button', value: '#ionize_label_add_content_element'
			div '#tArticleMediaButton.toolbox', ->
				input '#addMedia.fmButton.toolbar-button pictures', type: 'button', value: '#ionize_label_attach_media'
